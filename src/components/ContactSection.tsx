        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            >
              ...
              <p className="text-muted-foreground font-poppins">sahanasri18@gmail.com</p>
            </a>
            ...
            >
              ...
              <p className="text-muted-foreground font-poppins">Connect with me</p>
            </a>
          </div>
          ...
          <div className="flex flex-wrap gap-3 justify-center mb-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-full hover:bg-primary/80 transition-all duration-300 shadow-soft font-medium font-poppins"
            >
              <Github size={18} /> GitHub
            </a>
            <a
              href="mailto:sahanasri18@gmail.com"
              className="inline-flex items-center gap-2 px-6 py-3 bg-foreground text-background rounded-full hover:bg-foreground/90 transition-all duration-300 shadow-soft font-medium font-poppins"
            >
